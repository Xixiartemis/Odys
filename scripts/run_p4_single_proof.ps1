...
# HUMAN_SECRET_EXECUTION: the value is checked for presence only.
...
$outputPath = "D:\projects\odys-p411-official\results\official_phase4\cheap_model\single_proof_v1"
$runner = "$repoRoot\scripts\run_p4_single_proof.py"
...
if ($LASTEXITCODE -ne 0) {
    throw "SINGLE_PROOF_EXECUTION_FAILED:$LASTEXITCODE"
}

Write-Output "SINGLE_PROOF_EXECUTION_COMPLETE"
